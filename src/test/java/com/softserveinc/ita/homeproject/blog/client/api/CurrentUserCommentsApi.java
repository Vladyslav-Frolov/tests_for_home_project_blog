...
public class CurrentUserCommentsApi {
   ...
   */
  public Comment getCommentByCurrentUser(BigDecimal id) throws ApiException {
    return getCommentByCurrentUserWithHttpInfo(id).getData();
  }
   ...
   */
  public ApiResponse<Comment> getCommentByCurrentUserWithHttpInfo(BigDecimal id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getCommentByCurrentUser");
    }
    ...
    return apiClient.invokeAPI("CurrentUserCommentsApi.getCommentByCurrentUser", localVarPath, "GET", localVarQueryParams, localVarPostBody,
   ...
   */
  public List<Comment> getCommentsByCurrentUser(BigDecimal id, String sort, Integer pageNum, Integer pageSize) throws ApiException {
    return getCommentsByCurrentUserWithHttpInfo(id, sort, pageNum, pageSize).getData();
  }
   ...
   */
  public ApiResponse<List<Comment>> getCommentsByCurrentUserWithHttpInfo(BigDecimal id, String sort, Integer pageNum, Integer pageSize) throws ApiException {
    Object localVarPostBody = null;
    ...
    return apiClient.invokeAPI("CurrentUserCommentsApi.getCommentsByCurrentUser", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  /**
   ...
   */
  public void removeCommentByCurrentUser(BigDecimal id) throws ApiException {
   ...
   */
  public ApiResponse<Void> removeCommentByCurrentUserWithHttpInfo(BigDecimal id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling removeCommentByCurrentUser");
    }
    ...
    return apiClient.invokeAPI("CurrentUserCommentsApi.removeCommentByCurrentUser", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   */
  public Comment updateCommentByCurrentUser(BigDecimal id, Comment comment) throws ApiException {
    return updateCommentByCurrentUserWithHttpInfo(id, comment).getData();
  }
   ...
   */
  public ApiResponse<Comment> updateCommentByCurrentUserWithHttpInfo(BigDecimal id, Comment comment) throws ApiException {
    Object localVarPostBody = comment;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling updateCommentByCurrentUser");
    }
    
    // verify the required parameter 'comment' is set
    if (comment == null) {
      throw new ApiException(400, "Missing the required parameter 'comment' when calling updateCommentByCurrentUser");
    }
    ...
    return apiClient.invokeAPI("CurrentUserCommentsApi.updateCommentByCurrentUser", localVarPath, "PUT", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
