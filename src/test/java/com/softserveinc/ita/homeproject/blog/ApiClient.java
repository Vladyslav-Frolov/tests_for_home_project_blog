...
import com.softserveinc.ita.homeproject.blog.auth.Authentication;
import com.softserveinc.ita.homeproject.blog.auth.HttpBasicAuth;
import com.softserveinc.ita.homeproject.blog.auth.HttpBearerAuth;
import com.softserveinc.ita.homeproject.blog.auth.ApiKeyAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "http://localhost:8080/api/1";
  ...
  public ApiClient configureApiKeys(Map<String, String> secrets) {
    for (Entry<String, Authentication> authEntry : authentications.entrySet()) {
  ...
  public ClientConfig getDefaultClientConfig() {
    ...
    if (debugging) {
      clientConfig.register(new LoggingFeature(Logger.getLogger(LoggingFeature.DEFAULT_LOGGER_NAME), Level.INFO, LoggingFeature.Verbosity.PAYLOAD_ANY, 1024*50 /* Log payloads up to 50K */));
